...
static void
output_surface_for_each_surface_iterator(struct wlr_surface *surface, int sx, int sy, void *user_data)
{
				...
				void *user_data)
{
	...
	wlr_surface_for_each_surface(surface, output_surface_for_each_surface_iterator, &data);
}
...
static void
damage_surface_iterator(struct cg_output *output, struct wlr_surface *surface, struct wlr_box *box, void *_data)
{
	struct wlr_output *wlr_output = output->wlr_output;
	bool whole = *(bool *)_data;
...
handle_output_damage_frame(struct wl_listener *listener, void *data)
{
	...
	output_render(output, &buffer_damage);
